...
InlineCompletionTriggerKind = uint
...
PrepareSupportDefaultBehavior = uint
...
@dataclass
class DocumentColorRegistrationOptions(TextDocumentRegistrationOptions, DocumentColorOptions, StaticRegistrationOptions):
	""""""
...
class FoldingRange:
	...
	startCharacter: uint = optional_field()
	"""The zero-based character offset from where the folded range starts. If not defined, defaults to the length of the start line."""
	endLine: uint
	"""The zero-based end line of the range to fold. The folded area ends with the line's last character.
	To be valid, the end must be zero or larger and smaller than the number of lines in the document."""
	endCharacter: uint = optional_field()
...
class SemanticTokensOptions(WorkDoneProgressOptions):
	...
	range: Union[bool, Literal[{'properties': []}]] = optional_field()
...
class TextDocumentContentChangePartial:
	...
	rangeLength: uint = optional_field()
...
class FoldingRangeClientCapabilities:
	...
	rangeLimit: uint = optional_field()
...
@dataclass
class _InitializeParams(WorkDoneProgressParams):
...
class SignatureInformation:
	...
	activeParameter: Union[uint, None] = optional_field()
...
class SignatureHelp:
	...
	activeSignature: uint = optional_field()
...
class ApplyWorkspaceEditResult:
	...
	failedChange: uint = optional_field()
...
class WorkDoneProgressBegin:
	...
	percentage: uint = optional_field()
